...
public class HKAPPProcess {
	...
	static {
		...
		String fileType= Constants.HK_APPROACH_PLATINUM;
		...
		String pointsToApproachId = dao.getCustomFieldId(fileType, "POINTS_TO_PLATINUM1");
		...
		importFields.put("POINTS_TO_PLATINUM1", "{{CustomObject["
	...
	private static Map<String, Object> prepareLeadData(CDODetails cdoDetail) {
		...
		if (cdoDetail != null) {
			...
			cdoData.put("POINTS_TO_PLATINUM1", cdoDetail.getPointsToApproach());
