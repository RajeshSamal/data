...
public class HKER3Process {
	...
	static {
		...
		String fileType= Constants.HK_ENGAGEMENT_REMINDER3;
	...
	public static CDODetails processHKER3(CommonModel model) {
	...
	public static List<Map<String, Object>> getCDOListForHKER3(
		...
		for (CDODetails cdoDetail : cdoDetailsList) {
			cdoDataList.add(prepareHKER3LeadData(cdoDetail));
		}
		return cdoDataList;
	}

	private static Map<String, Object> prepareHKER3LeadData(CDODetails cdoDetail) {
