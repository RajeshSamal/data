...
public class HKAPGProcess {
	...
	static {
		...
		String fileType= Constants.HK_APPROACH_GOLD;
		...
		String pointsToApproachId = dao.getCustomFieldId(fileType, "POINTS_TO_GOLD1");
		...
		importFields.put("POINTS_TO_GOLD1", "{{CustomObject["
	...
	private static Map<String, Object> prepareLeadData(CDODetails cdoDetail) {
		...
		if (cdoDetail != null) {
			...
			cdoData.put("POINTS_TO_GOLD1", cdoDetail.getPointsToApproach());
