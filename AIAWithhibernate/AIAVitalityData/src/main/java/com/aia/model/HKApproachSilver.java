...
@Entity
@Table(name = "HK_APPROACH_SILVER")
public class HKApproachSilver implements CommonModel,CommonDBColumn {

	@Id
	@Column(name = "HK_APPROACH_SILVER_ID")
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int hkApproachSilverId;
	...
	public HKApproachSilver(){
		
	}
	public int getHkApproachSilverId() {
		return hkApproachSilverId;
	}
	public void setHkApproachGoldId(int hkApproachSilverId) {
		this.hkApproachSilverId = hkApproachSilverId;
	}
	...
	public boolean equals(Object other) {
		...
		if (other instanceof HKApproachSilver) {
			HKApproachSilver that = (HKApproachSilver) other;
