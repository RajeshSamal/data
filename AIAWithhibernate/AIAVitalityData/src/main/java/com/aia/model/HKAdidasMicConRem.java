...
@Entity
@Table(name = "HK_ADIDAS_MIC_CON_REM")
public class HKAdidasMicConRem implements CommonModel,CommonDBColumn {

	@Id
	@Column(name = "HK_ADIDAS_ID")
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int hkAdidasIdId;
	...
	public int getHkAdidasIdId() {
		return hkAdidasIdId;
	}

	public void setHkAdidasIdId(int hkAdidasIdId) {
		this.hkAdidasIdId = hkAdidasIdId;
	}
	...
	public boolean equals(Object other) {
		...
		if (other instanceof HKAdidasMicConRem) {
			HKAdidasMicConRem that = (HKAdidasMicConRem) other;
