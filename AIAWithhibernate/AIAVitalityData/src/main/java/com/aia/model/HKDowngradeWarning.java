...
@Entity
@Table(name = "HK_DOWNGRADE_WARNING")
public class HKDowngradeWarning implements CommonModel,CommonDBColumn {

	@Id
	@Column(name = "HK_DOWNGRADE_WARNING_ID")
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int hkDowngradeWarningId;
	...
	@Column(name = "POINTS_TO_MAINTAIN_STATUS")
	private String pointsToMantainStatus;
	...
	public int getHkDowngradeWarningId() {
		return hkDowngradeWarningId;
	}
	public void setHkDowngradeWarningId(int hkDowngradeWarningId) {
		this.hkDowngradeWarningId = hkDowngradeWarningId;
	}
	...
	public String getPointsToMantainStatus() {
		return pointsToMantainStatus;
	}
	public void setPointsToMantainStatus(String pointsToMantainStatus) {
		this.pointsToMantainStatus = pointsToMantainStatus;
	}
