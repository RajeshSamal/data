...
@Entity
@Table(name = "HK_ENGAGEMENT_REMINDER2")
public class HKEngagementReminder2 implements CommonModel,CommonDBColumn{

	@Id
	@Column(name = "HK_ENGAGEMENT_REMINDER2_ID")
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int hkEngagementReminder2Id;
	...
	public HKEngagementReminder2() {
	}

	public int getHkEngagementReminder2Id() {
		return hkEngagementReminder2Id;
	}

	public void setHkEngagementReminder2Id(int hkEngagementReminder1Id) {
		this.hkEngagementReminder2Id = hkEngagementReminder1Id;
	}
	...
	public boolean equals(Object other) {
		...
		if (other instanceof HKEngagementReminder2) {
			HKEngagementReminder2 that = (HKEngagementReminder2) other;
