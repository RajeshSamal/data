...
@Entity
@Table(name = "HK_APPROACH_GOLD")
public class HKApproachGold implements CommonModel,CommonDBColumn {

	@Id
	@Column(name = "HK_APPROACH_GOLD_ID")
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int hkApproachGoldId;
	...
	public HKApproachGold(){
		
	}
	public int getHkApproachGoldId() {
		return hkApproachGoldId;
	}
	public void setHkApproachGoldId(int hkApproachGoldId) {
		this.hkApproachGoldId = hkApproachGoldId;
	}
